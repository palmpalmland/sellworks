...
export default function MarketingUpgradeBar() {
  return (
    <div className="fixed bottom-8 left-1/2 z-[90] w-full max-w-2xl -translate-x-1/2 px-4">
      <div className="panel flex items-center justify-between gap-4 border-[#6C5CE7]/20 bg-[color:var(--panel-strong)] p-4 shadow-[0_0_30px_rgba(108,92,231,0.12)] backdrop-blur-xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="theme-text text-sm font-bold">Unlock full content kit</p>
            <p className="theme-text-muted text-xs">Get high-res assets and unlimited generations.</p>
          </div>
        </div>
